...
/**
 * Provides a form for deleting a field_store entity.
 *
 * @ingroup validated_fields
 */
class FieldStoreDeleteForm extends ContentEntityConfirmFormBase {
  ...
  public function getCancelUrl() {
    return new Url('entity.field_store.collection');
  }
