...
namespace Drupal\content_validations\Plugin\rest\resource;
...
use Drupal\content_validations\Plugin\ValidationPluginManager;
...
class ValidationResource extends ResourceBase {
  ...
  public static function create(ContainerInterface $container, array $configuration, $plugin_id, $plugin_definition) {
    ...
    return new static(
      ...
      $container->get('plugin.manager.validation_plugin')
    );
  }
   ...
   *   The current request
   * @param ValidationPluginManager $validation_manager
   *   The Validation Plugin Manager
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, array $serializer_formats, LoggerInterface $logger, AccountProxyInterface $current_user, Request $current_request, ValidationPluginManager $validation_manager) {
